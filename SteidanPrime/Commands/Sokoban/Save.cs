...
namespace SteidanPrime.Commands.Sokoban
{
    public class Save : InteractionModuleBase<SocketInteractionContext>
    {
        ...
        public Save(ISaveboardService saveboardService, ISaveboardRepository saveboardRepository)
        {
        ...
        {
            if (!_saveboardRepository.GetSaveChannels().ContainsKey(Context.Guild.Id))
            {
            ...
            var saveChannelId = _saveboardRepository.GetSaveChannels()[Context.Guild.Id];
        ...
        {
            _saveboardRepository.GetSaveChannels()[Context.Guild.Id] = Context.Channel.Id;
